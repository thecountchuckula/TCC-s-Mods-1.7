...
public class ItemBlackPearlHelmet extends ItemArmor {

    public ItemBlackPearlHelmet(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4, String type) {
