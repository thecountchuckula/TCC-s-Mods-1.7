...
public class ItemBlackPearlBoots extends ItemArmor {

    public ItemBlackPearlBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4, String type) {
        super(par1, par2EnumArmorMaterial, par3, par4);
        // TODO Auto-generated constructor stub
        this.setMaxStackSize(1);
        this.setCreativeTab(MotherOfPearl.tabMoP);
        this.setUnlocalizedName("bootsBlackPearl");
    }
