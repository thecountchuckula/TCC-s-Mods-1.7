...
public class WorldGenMinablePearl extends WorldGenerator {
    ...
    public WorldGenMinablePearl(int par1, int par2) {
        this(par1, par2, ModBlocks.pearlstone.blockID);
    }

    public WorldGenMinablePearl(int par1, int par2, int par3) {
        this.minableBlockId = par1;
        this.numberOfBlocks = par2;
        this.field_94523_c = par3;
    }

    public WorldGenMinablePearl(int id, int meta, int number, int target) {
