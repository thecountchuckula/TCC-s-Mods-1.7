...
public class WorldProviderPearl extends WorldProvider {
    ...
    public void registerWorldChunkManager() {
        ...
        this.dimensionId = Reference.DIMID_1;
        this.hasNoSky = false;
    }
    ...
    public String getWelcomeMessage() {
        if ((this instanceof WorldProviderPearl)) {
            return "Entering Water World";
        }
        return null;
    }
