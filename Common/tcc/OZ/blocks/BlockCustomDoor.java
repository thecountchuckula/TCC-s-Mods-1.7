...
public class BlockCustomDoor extends Block
{
    ...
    protected BlockCustomDoor(int par1, Material par2Material, Block par3Block)
    {
        super(par1, par2Material);
        this.DoorID = par3Block.blockID;
        float f = 0.5F;
        float f1 = 1.0F;
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.field_111044_a[0] = par1IconRegister.registerIcon(Reference.MOD_ID.toLowerCase() + ":" + this.getUnlocalizedName().substring(5) + "_upper");
        this.field_111043_b[0] = par1IconRegister.registerIcon(Reference.MOD_ID.toLowerCase() + ":" + this.getUnlocalizedName().substring(5) + "_lower");
    ...
    {
        if (this.DoorID == ModBlocks.EmeraldStone.blockID)
        {
    ...
    {
        return (par1 & 8) != 0 ? 0 : (this.DoorID == ModBlocks.EmeraldStone.blockID ? ModItems.EmeraldDoor.itemID : null);
    }
    ...
    {
        return this.DoorID == ModBlocks.EmeraldStone.blockID ? ModItems.EmeraldDoor.itemID : null;
    }
