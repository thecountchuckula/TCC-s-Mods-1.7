package com.thecountchuckula.coolwands.entity;
...
public class EntityRock extends EntityThrowable
{
    ...
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
        ...
        {
            this.worldObj.spawnEntityInWorld(new EntityItem(this.worldObj, this.posX, this.posY, this.posZ, ItemStacks.rock));
        }
        if (par1MovingObjectPosition.entityHit != null)
        {
            byte b0 = 4;
